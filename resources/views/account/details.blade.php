...
@include('includes.accountNav')
	...
	<form class="form-horizontal form-light" method="post" action="/account/details">
	@csrf
					<div class="panel panel-default">
						...
						<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" id="address_1" name="address_1" value="{{ auth()->user()->address_1 }}">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" id="address_2" name="address_2" value="{{ auth()->user()->address_2 }}">
									</div>
								</div>
